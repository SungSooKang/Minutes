...
// 회의 주최자명과 회의록명 (라벨 or 아이템)

// 앱 시작 시 기본적으로 나타낼 목록
var items = ["공지사항", "general", "rp3_ios_a", "sq_overflow"]
var itemsImageFile = ["우노.png", "캉.png", "쿠기.png", "둘리.png"]
...
class TableViewController: UITableViewController {
    ...
    // 만약 초기값을 선언했다면, 그 값(items와 itemsImageFile)을 셀에 삽입함
...
extension TableViewController: EditDelegate{
    // 수정된 회의록명 반영
